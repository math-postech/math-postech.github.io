...
- [Week 1: Matrix Arithmetic](./notes/matrix-arithmetic.md) — Three views of $AB=C$, ingredient table interpretation
- [Week 2: Matrix Equations and Row Operations](./notes/matrix-equations.md) — Concept redefinition, row/column operations, solving equations, matrix inverses
